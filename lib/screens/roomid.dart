...
class RoomSignIn extends StatelessWidget {
  const RoomSignIn({super.key});
      ...
      body: Container(
        ...
        child: SafeArea(
          ...
          children: [
            ...
            myTextField("E-Rental RoomID", Colors.white),
            ...
            myTextField("E-Rental Password", Colors.black26),
            const SizedBox(height: 5),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20.0),
              child: Align(
